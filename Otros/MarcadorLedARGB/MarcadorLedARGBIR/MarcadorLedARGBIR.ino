...
void loop()
{
  ...
  {
    if(IrReceiver.decodedIRData.command == RED_UP_CMD)
    {
    ...
    else if(IrReceiver.decodedIRData.command == RED_DOWN_CMD)
    {
    ...
    else if(IrReceiver.decodedIRData.command == BLUE_UP_CMD)
    {
    ...
    else if(IrReceiver.decodedIRData.command == BLUE_DOWN_CMD)
    {
    ...
    else if(IrReceiver.decodedIRData.command == RESET_CMD)
    {
