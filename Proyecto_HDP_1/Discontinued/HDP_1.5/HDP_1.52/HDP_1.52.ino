...
const float vmax[2] = {18,13.5}; // voltaje al que deja de cargar
const float vload[2] = {15.5,12}; // voltaje al que empieza a cargar
const float vmin[2] = {13,11}; // voltaje al que deja de funcionar el sistema
unsigned const int ciclos = 401; // tiempo de subir al cubo grande (seg) * 10 + 1
